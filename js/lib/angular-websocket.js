(function() {
  ...
  function $WebSocketProvider($rootScope, $q, $timeout, $websocketBackend) {
    ...
    $WebSocket.prototype.myName = "";
    $WebSocket.prototype.receiver = "";
    $WebSocket.prototype.userLists = [];
    $WebSocket.prototype.messages = [];
    ...
    $WebSocket.prototype.send = function send(type, data) {
      //console.log(data);
      ...
      if (self.readyState === self._readyStateConstants.RECONNECT_ABORTED) {
        ...
        self.sendQueue.push({
          message: JSON.stringify(dataJSON),
          deferred: deferred
        });
        self.fireQueue();
      }
